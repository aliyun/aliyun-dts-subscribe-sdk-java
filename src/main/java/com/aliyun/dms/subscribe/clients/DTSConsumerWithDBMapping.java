...
public class DTSConsumerWithDBMapping implements com.aliyun.dts.subscribe.clients.DTSConsumer {
    ...
    private static List<WorkThread> startWorker(EtlRecordProcessor etlRecordProcessor, UserRecordGeneratorWithDBMapping userRecordGenerator, KafkaRecordFetcher recordGenerator) {
        ...
        ret.add(new WorkThread(userRecordGenerator, UserRecordGeneratorWithDBMapping.class.getName()));
