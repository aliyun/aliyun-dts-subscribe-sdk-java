...
public class DataFilterUtil {
     ...
     */
    public static void putColNames(String db, String tb, List<String> cols, DataFilter dataFilterBase) {
     ...
     */
    public static List<String> getColNamesWithMapping(String db, String tb, DataFilter dataFilterBase) {
        if (tb == null) {
            return null;
        }
     ...
     * @return cols reference to corresponded db name and table name
     */
    public static List<String> getColNames(String db, String tb, DataFilter dataFilterBase) {
        if (tb == null) {
            return null;
        }
