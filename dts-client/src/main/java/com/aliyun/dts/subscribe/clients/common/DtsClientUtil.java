...
public class DtsClientUtil {
    ...
    public static Checkpoint parseCheckpoint(String checkpoint) {
    ...
    public static ConsumerContext.ConsumerSubscribeMode parseConsumerSubscribeMode(String value) {
