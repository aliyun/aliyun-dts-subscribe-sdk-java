...
public class Timestamp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * @return A new Timestamp RecordBuilder
   */
  public static Timestamp.Builder newBuilder(Timestamp.Builder other) {
    return new Timestamp.Builder(other);
  }
   ...
   * @return A new Timestamp RecordBuilder
   */
  public static Timestamp.Builder newBuilder(Timestamp other) {
    return new Timestamp.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Timestamp>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Timestamp.Builder other) {
      super(other);
     ...
     * @return This builder.
     */
    public Timestamp.Builder setTimestamp(long value) {
     ...
     * @return This builder.
     */
    public Timestamp.Builder clearTimestamp() {
     ...
     * @return This builder.
     */
    public Timestamp.Builder setMillis(int value) {
     ...
     * @return This builder.
     */
    public Timestamp.Builder clearMillis() {
