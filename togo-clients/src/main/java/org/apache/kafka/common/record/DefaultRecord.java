...
public class DefaultRecord implements Record {
    ...
    public static final byte UNUSED_ATTRIBUTES = 0;
    public static Record copyRecordWithGivenOffset(Record recordToCopy, long offsetGiven) {
        return new DefaultRecord(recordToCopy.sizeInBytes(), UNUSED_ATTRIBUTES,
                offsetGiven, recordToCopy.timestamp(), recordToCopy.sequence(),
                recordToCopy.key(), recordToCopy.value(), recordToCopy.headers());
    }
}
