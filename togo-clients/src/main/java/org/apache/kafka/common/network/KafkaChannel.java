...
import com.taobao.drc.togo.util.TopicAliasMeta;
...
public class KafkaChannel {
    ...
    // Hold user defined object for customer usage
    private Map<TopicPartition, Closeable> userObject;
    private TopicAliasMeta topicAliasMeta;
    private AtomicBoolean extraInfoNotInitialized = new AtomicBoolean(true);
    private AtomicBoolean aclNotInitialized = new AtomicBoolean(true);
    private boolean isSaslConnection = false;
    ...
    public void close() throws IOException {
        ...
        if (null != userObject) {
            userObject.values().forEach(object -> {
                try {
                    object.close();
                } catch (Exception e) {
                    // do nothing
    ...
    public void setUserObject(Map<TopicPartition, Closeable> object) {
        extraInfoNotInitialized.set(false);;
        userObject = object;
    }
    ...
    public boolean extraInfoNotInitialized() {
        return extraInfoNotInitialized.get();
    }
    public void setExtraInfoInitialized(int privilegeCode) {
        extraInfoNotInitialized.set(false);
        this.privilegeCode = privilegeCode;
    }

    public boolean aclNotInitialized() {
        return aclNotInitialized.compareAndSet(true, false);
    }

    public boolean isSaslConnection() {
        return isSaslConnection;
    }

    public void setTopicAliasMeta(TopicAliasMeta topicAliasMeta) {
        this.topicAliasMeta = topicAliasMeta;
    }

    public TopicAliasMeta getTopicAliasMeta() {
        return topicAliasMeta;
    }
