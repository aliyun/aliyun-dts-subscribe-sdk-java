...
public class MetadataResponseData implements ApiMessage {
    ...
    private static final Schema SCHEMA_64 = SCHEMA_5;
    ...
    public static Schema[] schemaVersions() {
        return fillSchemaWithGap(new Schema[]{SCHEMA_0, SCHEMA_1, SCHEMA_2, SCHEMA_3,
                SCHEMA_4, SCHEMA_5, SCHEMA_6, SCHEMA_7, SCHEMA_8 , SCHEMA_9}, SCHEMA_9, 63, SCHEMA_64);
    }
    ...
    public MetadataResponseData(MetadataResponseBrokerCollection brokers, String clusterId, int controllerId,
                                MetadataResponseTopicCollection topicMetadata) {
        this.brokers = brokers;
        this.clusterId = clusterId;
        this.controllerId = controllerId;
        this.topics = topicMetadata;
    }
