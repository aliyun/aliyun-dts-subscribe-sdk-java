...
public class JaasContext {
     ...
     */
    public static JaasContext load(Type contextType, ListenerName listenerName,
                                   Map<String, ?> configs) {
    ...
    static JaasContext load(Type contextType, String listenerContextName,
    ...
    private static JaasContext defaultContext(Type contextType, String listenerContextName,
                                              String globalContextName) {
