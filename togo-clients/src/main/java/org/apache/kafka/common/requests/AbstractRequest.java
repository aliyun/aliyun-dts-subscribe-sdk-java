...
public abstract class AbstractRequest extends AbstractRequestResponse {
    ...
    public static AbstractRequest parseRequest(ApiKeys apiKey, short apiVersion, Struct struct) {
        switch (apiKey) {
            ...
            // Below is TOGO apis' processor
            case  CREATE_RECORD_METAS:
                return new CreateRecordMetasRequest(struct, apiVersion);
            case FETCH_RECORD_METAS:
                return new FetchRecordMetasRequest(struct, apiVersion);
            case FLEX_LIST_OFFSET:
                return new FlexListOffsetRequest(struct, apiVersion);
            case SET_FETCH_TAGS:
                return new SetFetchTagsRequest(struct, apiVersion);
            case RELOAD_AUTH_META:
                return new ReloadAuthMetaRequest(struct, apiVersion);
            default:
