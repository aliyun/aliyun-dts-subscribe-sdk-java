...
public class KafkaPrincipal implements Principal {
    ...
    public KafkaPrincipal(String principalType, String name, boolean isEncoded) {
        this.principalType = requireNonNull(principalType, "Principal type cannot be null");
        this.name = requireNonNull(name, "Principal name cannot be null");
        this.isEncoded = isEncoded;
        if (isEncoded) {
            actualUserName = SIDUtil.getUserNameFromString(name);
            sid = SIDUtil.getSIDFromString(name);
        } else {
            actualUserName = name;
            sid = name;
        }
