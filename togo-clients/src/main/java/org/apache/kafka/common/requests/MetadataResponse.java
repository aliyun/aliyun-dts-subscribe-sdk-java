...
import org.apache.kafka.common.requests.MetadataResponseData.MetadataResponseBroker;
import org.apache.kafka.common.requests.MetadataResponseData.MetadataResponsePartition;
import org.apache.kafka.common.requests.MetadataResponseData.MetadataResponseTopic;
...
public class MetadataResponse extends AbstractResponse {
    ...
    public MetadataResponse(int throttleTimeMs, List<Node> brokers, String clusterId, int controllerId, List<TopicMetadata> topicMetadata) {
        MetadataResponse metadataResponse = prepareResponse(throttleTimeMs, brokers, clusterId, controllerId, topicMetadata);
        this.data = metadataResponse.data;
        this.holder = metadataResponse.holder;
    }
    ...
    public static class PartitionMetadata {
        ...
        public PartitionMetadata(Errors error,
            ...
            this(error, partition, leader, Optional.empty(), replicas, isr, offlineReplicas);
        }
