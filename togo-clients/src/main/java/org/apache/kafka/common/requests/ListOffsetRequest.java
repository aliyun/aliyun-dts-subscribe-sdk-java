...
public class ListOffsetRequest extends AbstractRequest {
    ...
    public ListOffsetRequest(int replicaId, IsolationLevel isolationLevel, Map<TopicPartition, PartitionData> offsetData,
                             Map<TopicPartition, Long> partitionTimestamps, Set<TopicPartition> duplicatePartitions, short version) {
        super(version);
