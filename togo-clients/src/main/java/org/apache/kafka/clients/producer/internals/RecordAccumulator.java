...
import com.taobao.drc.togo.util.SetOffsetMeta;
...
public final class RecordAccumulator {
    ...
    private SetOffsetMeta setOffsetMeta;
    ...
    public RecordAccumulator(LogContext logContext,
        ...
        this.setOffsetMeta = new SetOffsetMeta(0L);
    ...
    public RecordAppendResult append(TopicPartition tp,
        ...
        try {
            ...
            synchronized (dq) {
                ...
                MemoryRecordsBuilder recordsBuilder = recordsBuilder(buffer, maxUsableMagic, tp);
    ...
    private MemoryRecordsBuilder recordsBuilder(ByteBuffer buffer, byte maxUsableMagic, TopicPartition tp) {
        if (transactionManager != null && maxUsableMagic < RecordBatch.MAGIC_VALUE_V2) {
            throw new UnsupportedVersionException("Attempting to use idempotence with a broker which does not " +
                    "support the required message format (v2). The broker must be version 0.11 or later.");
        }
        Long offset = setOffsetMeta.retrieveOffset(tp);
        return MemoryRecords.builder(buffer, maxUsableMagic, compression, TimestampType.CREATE_TIME, offset);
    }
    ...
    /* Visible for testing */
    public Map<TopicPartition, Deque<ProducerBatch>> batches() {
    ...
    public boolean setOffsetForTP(TopicPartition tp, Long offset) {
        return setOffsetMeta.setOffsetForTP(tp, offset);
    }
