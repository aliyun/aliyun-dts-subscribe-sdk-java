...
public class CommonClientConfigs {
    ...
    public static final String METADATA_REQUEST_PROPERTIES_CONFIG = "metadata.request.props";
    public static final String METADATA_REQUEST_PROPERTIES_DOC = "A list of properties to be sent along with the meta data request.";
