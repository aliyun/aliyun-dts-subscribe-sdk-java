...
public class StickyAssignor extends AbstractPartitionAssignor {
    ...
    public Map<String, List<TopicPartition>> assign(Map<String, Integer> partitionsPerTopic,
        ...
        for (Entry<String, List<TopicPartition>> entry: currentAssignment.entrySet())
        ...
        for (Iterator<Entry<String, List<TopicPartition>>> it = currentAssignment.entrySet().iterator(); it.hasNext();) {
            Entry<String, List<TopicPartition>> entry = it.next();
    ...
    private void prepopulateCurrentAssignments(Map<String, Subscription> subscriptions,
        ...
        for (Entry<String, Subscription> subscriptionEntry : subscriptions.entrySet()) {
    ...
    private boolean isBalanced(Map<String, List<TopicPartition>> currentAssignment,
        ...
        for (Entry<String, List<TopicPartition>> entry: assignments) {
    ...
    static ByteBuffer serializeTopicPartitionAssignment(List<TopicPartition> partitions) {
        ...
        for (Entry<String, List<Integer>> topicEntry : CollectionUtils.groupDataByTopic(partitions).entrySet()) {
    ...
    private static class PartitionMovements {
        ...
        private boolean isSticky() {
            for (Entry<String, Map<ConsumerPair, Set<TopicPartition>>> topicMovements: this.partitionMovementsByTopic.entrySet()) {
