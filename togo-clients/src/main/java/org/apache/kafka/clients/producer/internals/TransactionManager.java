...
public class TransactionManager {
    ...
    public boolean hasProducerId(long producerId) {
    ...
    public synchronized int lastAckedSequence(TopicPartition topicPartition) {
    ...
    public synchronized long lastAckedOffset(TopicPartition topicPartition) {
    ...
    public synchronized boolean hasUnresolvedSequence(TopicPartition topicPartition) {
