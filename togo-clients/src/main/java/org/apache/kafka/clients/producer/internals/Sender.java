...
import com.taobao.drc.togo.client.producer.LeaderSwitchInterruptListener;
...
public class Sender implements Runnable {
    ...
    public void run() {
        ...
        while (running) {
            ...
            } catch (LeaderSwitchInterruptListener.LeaderSwitchException e) {
                log.error("Leader change for current producer, interrupt sender", e);
                // clean incomplete batch, shutdown network client and tell client leader changed
