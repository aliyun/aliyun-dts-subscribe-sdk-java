...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    protected final RecordAccumulator accumulator;
    ...
    private KafkaProducer(ProducerConfig config, Serializer<K> keySerializer, Serializer<V> valueSerializer) {
        try {
            ...
            NetworkClient client = createClient(
                    ...
                    throttleTimeSensor,
                    logContext);
            this.sender = createSender(logContext,
                    client,
                    this.metadata,
                    this.accumulator,
    ...
    protected Sender createSender(LogContext logContext,
                                  ...
                                  ApiVersions apiVersions) {
        return new Sender(logContext, client, metadata, accumulator, guaranteeMessageOrder, maxRequestSize, acks, retries,
