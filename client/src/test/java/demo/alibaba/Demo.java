...
public class Demo {
    private static String checkpointOfTimestamp = "1629685584";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                DataFilter filter = new DataFilter("buyers_0000;tc_biz_order_[0-9]*;*");
                ...
                client.initService("TT_new4test", "BUYERS_APP: buyers_0000", "7152115", checkpointOfTimestamp, null);
