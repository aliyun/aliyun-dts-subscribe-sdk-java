...
public class DemoDTS {
    private static String checkpointOfTimestamp = "1634720269";
    ...
    public static void main(String[] args) {
        ...
        props.put("manager.host", "http://dts-switch-zhangbei.alibaba.net:8088");
        ...
        while (true) {
            try {
                ...
                //过滤黑名单
                client.setBlackList("portal_proxy.user|db.table");
                ...
                client.initService("146196", "cn_shanghai_rm_dtsdailymeta.mysql.rdstest.tbsite.net_3306_dtsop_version2", "146196", checkpointOfTimestamp, null);
